      ...
      <div>
        ...
        <div className="sidebar">
          ...
          {duvs.map((duv) => (
            <div
              key={duv.duvGuid}
              className={`duv-item ${selectedDuv?.duvGuid === duv.duvGuid ? "selected" : ""}`}
      ...
      <div className="main">
        ...
        {modalDuvAberto && (
          <div className="modal">
            ...
            <select
              value={duvEmEdicao.navioGuid || ""}
              onChange={(e) => setDuvEmEdicao({ ...duvEmEdicao, navioGuid: e.target.value })}
            >
              <option value="">Selecione um navio</option>
              {navios.map((navio) => (
                <option key={navio.navioGuid} value={navio.navioGuid}>
        ...
        {selectedDuv ? (
          <>
            ...
            <div className="duv-action-buttons">
              ...
              <button className="botao botao-perigo" onClick={() => removerDuv(selectedDuv.duvGuid)}>Excluir</button>
            </div>
            ...
            <div className="pessoa-container">
              {selectedDuv.passageiros?.filter(p => !p.sid).map((p) => (
                <div key={p.passageiroGuid} className="pessoa-card">
                  ...
                  <button className="botao botao-perigo" onClick={() => removerPassageiro(p.passageiroGuid)}>Remover</button>
                </div>
              ))}
            </div>
